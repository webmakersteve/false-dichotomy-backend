...
const topicsModel = require('../api/graphql/topics');
const boardsModel = require('../api/graphql/boards');
...
module.exports.createServer = function createServer(globalConfig, svcs) {
  ...
  authenticatedRouter.post('/boards', boardsModel.graphqlMiddleware());
  authenticatedRouter.post('/topics', topicsModel.graphqlMiddleware());
